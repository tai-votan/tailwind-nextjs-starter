      ...
      <div className="divide-y">
        ...
        <div className="items-start space-y-2 xl:grid xl:grid-cols-3 xl:gap-x-8 xl:space-y-0">
          ...
          <div className="pt-8 pb-8 prose dark:prose-dark max-w-none xl:col-span-2">
            ...
            <p>
              He leads the clean energy group which develops 3D air pollution-climate models, writes differential
              equation solvers, and manufactures titanium plated air ballons. In his free time he bakes raspberry pi.
            </p>
            <p>
